...
<body>
  ...
  <center>
    ...
    <div id="NavBar">
      ...
      if(authCheck()){
      ?>
        <li class="NavBar" style="float:right;"><a href="/~daw277/messages.php">Messages<?php
      // Gets the number of unread messages sent to this user
      $numUnread = getUnreadMessages();
      // If there is new messages
      if($numUnread > 0)
      // Print the number along side the "Message Center" label
        echo "(" . $numUnread . ")";
      ?></a></li>
