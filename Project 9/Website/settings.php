...
<form action="" method="post" style="margin-bottom: 20px;">
  ...
  <table>
    <tbody>
      ...
      <tr>
        <td></td>
        <td><button class= "button" name="changePassword" value="Change Password" type="submit">Submit</button></td>
      </tr>
      ...
      <tr>
        <td></td>
        <td><button class="button" name="deleteUser" value="Delete User" type="submit">Delete User</button></td>
      </tr>
    </tbody>
  </table>
</form>
